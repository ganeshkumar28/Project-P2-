            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a style="text-decoration: none;" href="${pageContext.request.contextPath}/buyer/viewProductDetails?id=${product.productId}" class="btn-grad1" style="font-weight:900;font-size:18px;">View Details</a>
